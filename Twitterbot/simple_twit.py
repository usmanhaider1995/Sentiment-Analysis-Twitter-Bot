...
def create_api():
    ...
    consumer_key = "b2XWfXarUx6w2gIHNcK79FytB"
    consumer_secret = "pjc2ut5tsSloS9xIbOX5FhOkmkShKMeEI54C7dJVsJFbrFWWmw"
...
def send_media_tweet(api, text, filename):
...
def get_home_timeline(api , count):
...
def get_user_timeline(api, user, count = 20):
...
def get_retweets_of_me(api, count):
